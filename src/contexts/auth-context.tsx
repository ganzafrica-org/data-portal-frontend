...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const canViewRequest = (requestUserId: string): boolean => {
    ...
    if (user.role === "admin" || user.permissions.canViewAllRequests)
      return true;
    ...
    if (user.role === "external") {
      switch (user.userType) {
        case "individual":
          ...
          docs.push(
            {
              text: "Application letter addressed to the DG of NLA",
              category: "authorization",
              required: true,
            },
            {
              text: "Letter from research community or institution",
              category: "research",
              required: false,
            },
            {
              text: "Formal research proposal (objectives, methodology, duration, expected outcomes)",
              category: "research",
              required: false,
            },
          );
        ...
        case "private_company":
          docs.push(
            ...
            {
              text: "Concept note (why data is needed, objectives, methodology, expected outcomes)",
              category: "research",
              required: false,
            },
          );
      ...
      docs.push(
        {
          text: "Authorization letter from supervisor/department head",
          category: "authorization",
          required: true,
        },
        {
          text: "Project documentation (if applicable)",
          category: "research",
          required: false,
        },
      );
